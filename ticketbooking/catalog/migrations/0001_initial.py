...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='movies',
            fields=[
                ('movieID', models.UUIDField(default=uuid.uuid4, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adminID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shows', to='catalog.adminuser')),
                ('movieID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='movies', to='catalog.movies')),
            ],
        ),
        migrations.CreateModel(
            name='user',
